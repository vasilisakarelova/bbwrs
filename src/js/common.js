...
var artInit = function (p) {
  ...
  u('#art').on('click', function (e) {
    ...
    $wrap.first().style.visibility = 'hidden'
...
var designInit = function (p) {
  ...
  p.setup = function () {
    ...
    for (var i = 0; i < 15; i++) {
      boxes.push(new drawStack(Common.random(0, p.windowWidth), 0, Common.random(40, 300), Common.random(40, 300)));
    }
  }
...
// Multidisciplinary
// ----------------------------------------------------------------------------
var multidisciplinaryInit = function (p) {
  var $canvas
  var $title
